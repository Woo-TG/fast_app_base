...
final bankAccountShinhan2 = BankAccount(bankShinhan, 3000000 , accountTypeName: '저축예금');
final bankAccountShinhan3 = BankAccount(bankShinhan, 3000000 , accountTypeName: '저축예금');
